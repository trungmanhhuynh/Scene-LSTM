...
class Model_LSTM_Scene_nonlinear_noSF(nn.Module):
    def __init__(self, data_loader, args, train = False):
        super(Model_LSTM_Scene_nonlinear_noSF, self).__init__()
    ...
    def initialize_scene_data(self, data_loader, args):
        ...
        assert args.use_nonlinear_grids is True,"use_nonlinear_grids is False."       
        self.scene_info["nonlinear_grid_list"], _ = get_nonlinear_grids(data_loader, args)

...
inputData = dlmread('..\..\raw_data\ucy_zara02\data_pixels_2.5fps.txt');      % Specify data file
if(use_pixel)
    maxWidth  = 720; minWidth = 0 ;                                         % ETH_Hotel: [w,h] = [720,576]
    maxHeight = 576; minHeight = 0 ;                                        % ETH_Univ:  [w,h] = [640,480]
else
